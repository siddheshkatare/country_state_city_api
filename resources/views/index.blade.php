			...
			<div class="container-fluid position-relative py-2">
				...
				<div class="docs-top-utilities d-flex justify-content-end align-items-center">
					...
					<ul class="social-list list-inline mx-md-3 mx-lg-5 mb-0 d-none d-lg-flex">
						...
						<li class="list-inline-item">
							<a href="#">
								<i class="fab fa-slack fa-fw">
								</i>
							</a>
						</li>
						<li class="list-inline-item">
							<a href="#">
								<i class="fab fa-product-hunt fa-fw">
								</i>
							</a>
						</li>
					</ul>
							...
							<div class="card-body">
								<h5 class="card-title mb-3 text-center">
									<span class="card-title-text ">
										Welcome to Country State City API
									</span>
								</h5>
								<div class="card-text">
									Welcome to the Country State City API, your go-to resource for accessing
									comprehensive data on
									countries, states, and cities worldwide. Our API, built on Laravel and powered by
									the open-source
									database provided by Darshan Gada, offers developers a hassle-free solution for
									integrating
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<a class="card-link-mask" href="docs-page.html#section-1">
								</a>
							</div>
							<!--card-body-->
						</div>
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<a class="card-link-mask" href="docs-page.html#section-2">
								</a>
							</div>
							<!--card-body-->
						</div>
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<a class="card-link-mask" href="docs-page.html#section-3">
								</a>
							</div>
							<!--card-body-->
						</div>
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<a class="card-link-mask" href="docs-page.html#section-4">
								</a>
							</div>
							<!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    //card-body-->
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<a class="card-link-mask" href="docs-page.html#section-5">
								</a>
							</div>
							<!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            //card-body-->
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<a class="card-link-mask" href="docs-page.html#section-6">
								</a>
							</div>
							<!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    //card-body-->
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<a class="card-link-mask" href="docs-page.html#section-7">
								</a>
							</div>
							<!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            //card-body-->
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<a class="card-link-mask" href="docs-page.html#section-8">
								</a>
							</div>
							<!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    //card-body-->
					...
					<div class="col-12 col-lg-4 py-3">
						<div class="card shadow-sm">
							<div class="card-body">
								...
								<a class="card-link-mask" href="docs-page.html#section-9">
								</a>
							</div>
							<!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            //card-body-->
	...
	<section class="cta-section text-center py-5 theme-bg-dark position-relative">
		...
		<div class="container">
			...
			<div class="section-intro text-white mb-3 single-col-max mx-auto">
				...
				our
				premium
				<a class="text-white" href="https://themes.3rdwavemedia.com/bootstrap-templates/startup/coderpro-bootstrap-5-startup-template-for-software-projects/">
					Bootstrap
					5
					startup
					template
			...
			<div class="pt-3 text-center">
				<a class="btn btn-light" href="https://themes.3rdwavemedia.com/bootstrap-templates/startup/coderpro-bootstrap-5-startup-template-for-software-projects/">
					Get
					CoderPro
